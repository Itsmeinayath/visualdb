                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="bg-zinc-900 border border-zinc-800 p-3 rounded">
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-zinc-200">{tableData[currentRowIdx].age}</span>
                    </div>
                    
                    {checkingCondition ? (
                      <div className="flex items-center gap-2 text-accent text-xs">
                        <div className="w-3 h-3 rounded-full border border-accent border-t-transparent animate-spin" />
                        Evaluating: {tableData[currentRowIdx].age} &gt; 20
                      </div>
                    ) : (
                      <div className={`flex items-center gap-1.5 text-xs font-semibold ${tableData[currentRowIdx].age > 20 ? 'text-success' : 'text-zinc-500'}`}>
            ...
            <Table 
              ...
              highlightedRows={
                step === 4 && checkingCondition 
                  ? [tableData[currentRowIdx]?.id || currentRowIdx]
                  : []
              }
