      ...
      <div className="flex-none flex flex-col gap-6 mb-4">
        <header>
          ...
          <p className="text-muted-foreground text-base max-w-3xl leading-relaxed">
            The <code className="mx-1 px-1.5 py-0.5 rounded bg-muted text-foreground border border-border text-sm font-mono">INNER JOIN</code> clause merges rows from two different tables. The engine compares every row in the first table to every row in the second table (a nested loop) and keeps only the pairs that satisfy the <code className="text-pink-400 text-xs">ON</code> condition.
          </p>
        </header>
      </div>
