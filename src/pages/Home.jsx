...
const curriculum = [
  ...
  { to: "/distinct", label: "DISTINCT", desc: "Eliminate duplicate rows from results", step: 9, difficulty: "Intermediate", color: "text-amber-400", bg: "bg-amber-400/10 border-amber-400/20" },
